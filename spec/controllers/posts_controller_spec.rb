...
describe PostsController do
  ...
  describe "GET new" do
    it "not assigns a new post as @post" do
  ...
  describe "POST create" do
    describe "with valid params" do
      ...
      it "redirects to the created post" do
        ...
        post :create, :post => {}
        response.should_not redirect_to(post_url(mock_post))
      end
    end
  ...
  describe "PUT update" do
    describe "with valid params" do
      it "updates the requested post" do
        Post.stub(:find).with("37") { mock_post }
        mock_post.should_not_receive(:update_attributes).with({'these' => 'params'})
  ...
  describe "DELETE destroy" do
    ...
    it "redirects to the posts list" do
      ...
      delete :destroy, :id => "1"
      response.should_not redirect_to(posts_url)
    end
  end
  ...
  describe "with admin" do
    before do
      ...
      controller.send(:admin?).should be(true)
    end
